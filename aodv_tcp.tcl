...
set tracefile [open aodv_tcp_trace.tr w] 
$ns trace-all $tracefile 
#Open the NAM trace file 
#set windowVsTime2 [open aodv1.tr w]
set namfile [open aodv_tcp_nam.nam w] 
...
#$ns at 1.1 "plotWindow $udp1 $windowVsTime2"
